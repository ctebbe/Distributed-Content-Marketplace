...
public class FileStoreLookupRequest extends LookupRequest implements Event {
    ...
    protected FileStoreLookupRequest(int protocol, NodeConnection connection, String channel, String toLookup, String myId) {
        super(protocol, connection, channel, toLookup, myId);
    }

    protected FileStoreLookupRequest(int protocol, NodeConnection connection, String channel, String toLookup, String[] route, String id) {
