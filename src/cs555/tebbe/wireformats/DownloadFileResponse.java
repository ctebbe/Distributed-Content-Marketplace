 ...
 * Created by ctebbe
 */
public class DownloadFileResponse implements Event {

    private final Header header;
    public final String ID;
    public final byte[] bytes;

    protected DownloadFileResponse(int protocol, NodeConnection connection, String channel, String name, byte[] bytes) {
        header = new Header(protocol, connection, channel);
        this.ID = name;
        this.bytes = bytes;
    }

    protected DownloadFileResponse(byte[] marshalledBytes) throws IOException {
